...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pasajero.responsable'
        db.alter_column('ambulancia_pasajero', 'responsable_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ambulancia.Responsable'], default=1))

    def backwards(self, orm):

        # Changing field 'Pasajero.responsable'
        db.alter_column('ambulancia_pasajero', 'responsable_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['ambulancia.Responsable']))
